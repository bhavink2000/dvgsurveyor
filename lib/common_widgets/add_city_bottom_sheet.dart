...
class AddCityBottomSheet extends GetWidget<CityScreenController> {
  final bool isEdit;
  const AddCityBottomSheet({super.key, required this.isEdit});
                ...
                () => SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () => controller.onSubmit(
                      isEdit: isEdit,
                      existingCity: controller.editingCity,
                      isDelete: false,
                    ),
