class AppConst {
  ...
  static const String welcomeToDVG = "Welcome to $appName!";
  static const String welcomeMessage =
      "Your Home, Our Expertise: Discover the True Value of Your Space!";
  static const String getStarted = "Get Started";

  static const String login = "Login";
  static const String signUp = "Sign Up";
  static const String welcomeTo = "Welcome to";
  static const String enterYourDetails = "Enter your details to get started!";
  static const String createAccount = "Create Account";
  static const String fillInYourDetails = "Fill in your details to get started";
